        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Help us improve Drathos</p>
            </div>
          </div>
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-lg hover:bg-gray-700 flex items-center justify-center transition-colors text-gray-400 hover:text-white"
            disabled={loading}
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-gray-900 text-white px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 border border-gray-700 transition-all resize-none"
                rows={6}
                disabled={loading}
                required
              />
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-900 text-white px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 border border-gray-700 transition-all"
                disabled={loading}
              />
              <p className="text-xs text-gray-500 mt-1">
                ...
                <div className="mt-3 space-y-2 text-xs">
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <span className="text-gray-300 ml-2">{systemInfo.app?.version}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Platform:</span>
                      <span className="text-gray-300 ml-2">{systemInfo.system?.platform}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">OS Version:</span>
                      <span className="text-gray-300 ml-2">{systemInfo.system?.osVersion}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Memory:</span>
                      <span className="text-gray-300 ml-2">{systemInfo.system?.freeMemory} / {systemInfo.system?.totalMemory}</span>
                    </div>
                  </div>
